    ...
    <section>
      <div className="container">
        <div className="text-white py-[90px] max-w-[1100px] mx-auto flex gap-[77px]">
          <div data-aos-duration="2200" data-aos="fade-left" className="order-2">
          ...
          <div data-aos-duration="2200" data-aos="fade-right" className="ps-[60px] max-w-[671px] flex flex-col justify-center">
